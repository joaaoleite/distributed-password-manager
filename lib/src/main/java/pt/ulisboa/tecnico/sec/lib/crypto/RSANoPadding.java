...
public class RSANoPadding {
	...
	private Cipher cipher = Cipher.getInstance("RSA/ECB/NoPadding");

	public RSANoPadding(PublicKey publicKey, PrivateKey privateKey) throws Exception{
		this.publicKey = publicKey;
		this.privateKey = privateKey;
	}

	public RSANoPadding(KeyPair keys) throws Exception {
		this.publicKey = keys.getPublic();
		this.privateKey = keys.getPrivate();
	}

	public RSANoPadding(String pubKeyString) throws Exception {
		this.publicKey = stringToPublicKey(pubKeyString);
	}

	public RSANoPadding(PublicKey publicKey) throws Exception {
		this.publicKey = publicKey;
	}
